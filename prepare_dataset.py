...
csv_path = os.path.join(os.getcwd(), 'dataset\\balanced_train_segments.csv')
json_path = os.path.join(os.getcwd(), 'dataset\\ontology.json')
...
def get_compiled():
    ...
    compiled = []
    with open('dataset\\balanced_train_segments.csv', 'r') as f:
